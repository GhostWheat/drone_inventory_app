...
def create_drone(our_user):
    ...
    drone = Drone(name, description, price, camera_quality,\
                  flight_time, max_speed, dimensions, weight, cost_of_production, series, random_joke = random_joke, user_token = user_token)
...
# retrieve only one single drone
# dronely
